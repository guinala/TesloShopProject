        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
          ...
          
            {
              productsInCart.map( product => (
                <div key={product.slug } className="flex mb-5">
                  <Image src={`/products/${product.images[0]}`} width={100} height={100} alt={product.title} style={{width: '100px', height: '100px'}} className="mr-5 rounded"/>
                  <div>
                    <p>{product.title}</p>
          ...
          <div className="bg-white rounded-xl shadow-xl p-7">
            ...
            <div className="mt-5 mb-2 w-full">
              ...
              <div className="mb-5">
                <p className="mb-5">
                  <span className="text-xs">Al hacer clic en Realizar Pedido, aceptas nuestros términos y condiciones</span>
                </p>
              </div>
